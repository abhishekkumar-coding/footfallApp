...
const WHEEL_SIZE = width - 70;
const WHEEL_RATIO = 1 / 1;
const WHEEL_RADIUS =  WHEEL_RATIO * scale * WHEEL_SIZE;
...
class WheelOfFortune extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      finished: false,
      winner: null,
      gameScreen: new Animated.Value(WHEEL_RADIUS),
  ...
  return (
    <Text
      x={x}
      y={y - ((words.length - 1) * (this.fontSize || 16)) / 2}
      fill={'#fff'}
      textAnchor="middle"
      fontSize={18}
      fontWeight="bold"
      ...
      <Animated.View
        ...
        <Svg
          ...
          <Image
            ...
            style={{ width: knobSize + 10, height: (knobSize * 100) / 57 }}
          />
        </Svg>
      </Animated.View>
    );
