  ...
  return (
    <View style={styles.container}>
      ...
      >
        ...
        <Text style={styles.iconText}>{t('quick_actions.scan')}</Text>
      </TouchableOpacity>
      ...
      >
        ...
        <Text style={styles.iconText}>{t('quick_actions.offers')}</Text>
      </TouchableOpacity>
      ...
      >
        ...
        <Text style={styles.iconText}>{t('quick_actions.account')}</Text>
      </TouchableOpacity>
    </View>
  );
};
