...
const CashbackScreen = ({ navigation, route }) => {
  ...
  const [scanWithPurchaseAmount, { isLoading }] =
  ...
  return (
    <LinearGradient colors={['#000337', '#000000']} style={{ flex: 1 }}>
      <BackButton lable={t('claim_cashback')} back />

      <LinearGradient colors={['#7209b7', '#000']} style={styles.container}>
        <View style={styles.card}>
          ...
          >
            ...
            >
              <Text style={styles.title}>{t('purchase_amount')}</Text>
              <Text style={styles.rate}>{t('currency_rupee')}</Text>
            </View>
            <Text style={styles.description}>
              {t('enter_cashback_description')}
            </Text>
          </LinearGradient>
          <TextInput
            style={styles.input}
          ...
          <Text style={styles.returnPercent}>
            {t('cashback_rate')}
            <Text style={{ color: '#2b9348', fontFamily: 'Poppins-Bold' }}>
              {returnPercent}%
            </Text>
          </Text>
          ...
          >
            <Text style={styles.buttonText}>
              {isLoading ? t('calculating') : t('claim_cashback_button')}
            </Text>
          </TouchableOpacity>
        </View>
      </LinearGradient>
