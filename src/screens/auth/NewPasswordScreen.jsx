        ...
        <LinearGradient colors={['#000337', '#000']} style={{ flex: 1 }}>
            ...
            <View style={styles.container}>
                ...
                <View style={styles.inputContainer}>
                    ...
                    <CustomInput placeholder="Confirm your password" lable={'Confirm Password'} secureTextEntry={true} isPassword={true} iconComponent={<LockIcon />} value={newPassword} onChangeText={setNewPassword} />
                </View>
