...
const RedeemHistoryScreen = () => {
  ...
  const renderItem = ({ item }) => {
    ...
    return (
      <View style={styles.item}>
        <View style={{ width: '75%' }}>
          <Text style={styles.text}>{item?.reason || 'N/A'}</Text>
  ...
  return (
    <LinearGradient colors={['#000337', '#000000']} style={{ flex: 1, paddingVertical: hp(12), paddingHorizontal: 20 }}>
        <BackButton lable={"Redeem History"}/>
      {isLoading ? (
